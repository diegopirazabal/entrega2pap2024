...
<head>
    ...
    <style>
        #listaInsc, #listaCla, #soyEse, #costoClase, #idTipo {
            display: none;
        }
    </style>
</head>
    ...
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-center">
            ...
            <form action="cargarActividades" method="post" class="mb-4">
                <button type="submit" class="btn btn-primary btn-block">Cargar Actividades</button>
            </form>
        </div>

        <div class="d-flex justify-content-center">
            <!-- Formulario para seleccionar actividad y listar clases -->
            <form action="cargarClasesActividad" method="post" class="text-left mx-auto" style="max-width: 600px;">
                <div class="form-group">
                    <label for="actividadesList">Selecciona una actividad:</label>
                    <select id="actividadesList" name="actividades" onchange="mostrarElementos()" class="form-control"></select>
                    <button type="submit" class="btn btn-primary btn-block mt-3">Mostrar detalles</button>
                </div>
            </form>
        </div>
        ...
        <div class="d-flex justify-content-center flex-column">
            ...
            <input type="text" value="${nombreActividad}" class="form-control mb-3" readonly>
            <input type="text" value="${lugarActividad}" class="form-control mb-3" readonly>
            <input type="text" value="${duracionActividad}" class="form-control mb-3" readonly>
            <input type="text" value="${costoActividad}" class="form-control mb-3" readonly>

            <!-- Formulario para seleccionar una clase y ver detalles -->
            <form action="DetalleClaseDeActividad" method="post" class="text-left mx-auto" style="max-width: 600px;">
                <div class="form-group">
                    <label for="clasesList">Selecciona una clase:</label>
                    <select id="clasesList" name="clases" onchange="mostrarElementos()" class="form-control"></select>
                    <button type="submit" class="btn btn-primary btn-block mt-3">Desplegar Datos de la Clase</button>
                </div>
            </form>

            <!-- Mostrar información de la clase -->
            <input type="text" value="${nombreClase}" class="form-control mb-3" readonly>
            <input type="text" value="${fechaClase}" class="form-control mb-3" readonly>
            <input type="text" value="${horaClase}" class="form-control mb-3" readonly>
        </div>
