...
<head>
    ...
    <style>
        #listaAct, #listaCla, #listaInsc, #soyEse, #costoClase, #prueba {
            display: none;
        }
            ...
            <div class="col-md-6">
                <form action="perfil" method="post" class="text-center">
                    <div class="form-group">         
                        <button type="submit" class="btn btn-primary btn-block">Recargar mis datos</button>
                    </div>
                </form>
                 <div class="form-group">
                        ...
                        <button type="submit" id="botonGuardar" class="btn btn-primary btn-block">Guardar mis datos</button>
                    </form>    
                 </div>     
            </div>
        </div>
