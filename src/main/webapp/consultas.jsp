...
<body>
   <jsp:include page="/head.jsp"/>
	...
	<div class="d-flex justify-content-center">	
	<form action="DetalleUsuario" method="post" style="display: block; margin-bottom: 20px;">
	 		
			<div class="input-group-prepend" >
				<label for="exampleCedula">Nickname:  </label> <input type="text" name="nickname" style="width: 600px
				...
				placeholder="Ingrese Nickname">
				 ...
				 <button id="boton" type="button" class="btn">Mostrar Actividades</button>  <!-- Boton de arriba -->
		   </div>	
	<br>
