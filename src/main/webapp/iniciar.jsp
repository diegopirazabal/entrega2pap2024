...
<body>
    ...
    <div class="main-container">
        <div class="login-box">
            ...
            <p class="text-center text-muted">Por favor, ingresa tus credenciales</p>

            <!-- Formulario de login -->
            <form action="login" method="POST">
                <div class="form-group">
                    <label for="login">Cédula</label>
                    <input type="text" class="form-control input_blur" id="login" name="login"
                           value="Ingrese su cedula..." onMouseDown="sacarBlurReset(event);">
                </div>
