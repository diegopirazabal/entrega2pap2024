...
<body>
    ...
    <div class="container my-5">
        <div class="text-center">
            ...
            <form action="AgregarClase" method="post" class="text-left mx-auto" style="max-width: 600px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="hora" name="hora" class="form-control" placeholder="Hora de la clase (ej: 14:30)">
                </div>

                <div class="form-group">
                    <label for="lugar">Lugar:</label>
                    <input type="text" id="lugar" name="lugar" class="form-control" placeholder="Lugar de la clase">
                </div>

                <div class="form-group">
                    <label for="cupos">Cupos:</label>
                    <input type="number" name="cupos" class="form-control" id="cupos" placeholder="Cantidad de cupos disponibles">
                </div>
